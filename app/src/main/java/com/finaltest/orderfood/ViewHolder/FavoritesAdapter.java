...
public class FavoritesAdapter extends RecyclerView.Adapter<FavoritesViewHolder> {
    ...
    public void onBindViewHolder(@NonNull FavoritesViewHolder holder, final int position) {
        ...
        holder.food_price.setText(String.format("$ %s", favoritesList.get(position).getFoodPrice().toString()));
        Picasso.with(context).load(favoritesList.get(position).getFoodImage()).into(holder.food_image);
